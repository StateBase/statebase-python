...
if TYPE_CHECKING:
    from ..models.session_response_metadata_type_0 import SessionResponseMetadataType0
    from ..models.session_response_state import SessionResponseState
...
class SessionResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, SessionResponseMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> None | SessionResponseMetadataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = SessionResponseMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SessionResponseMetadataType0, data)

        metadata = _parse_metadata(d.pop("metadata"))

        state = SessionResponseState.from_dict(d.pop("state"))
